...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'ꪶ𝑸𝑼𝑬𝑬𝑵-𝑵𝑬𝑻𝑯𝑼ꫂ' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? '𝑰𝑻𝒁 𝑴𝑬 𝑺𝑨𝑯𝑨𝑵' : process.env.OWNER_NAME,
  ...
  BRANCH: 'main', 
  ALIVE_MESSAGE:  process.env.ALIVE_MESSAGE === undefined ? '𝑯𝑬𝒀 𝑸𝑼𝑬𝑬𝑵-𝑵𝑬𝑻𝑯𝑼 𝑾𝑯𝑨𝑻𝑺𝑨𝑷𝑷 𝑩𝑶𝑻 𝑼𝑺𝑬𝑹' : process.env.ALIVE_MESSAGE,
